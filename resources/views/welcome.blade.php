    ...
    <section class="container">
      ...
      {{-- <form class="form"> --}}
        <div>
          ...
          <label class="form__label" for="todo">~ You can Manage all the things here ~</label>
          
          <button class="button"><span><a href="{{route('login')}}">Login</a></span></button>
          <button class="button"><span><a href="{{route('register')}}">Register</a></span></button>
        </div>
      {{-- </forms> --}}
      <div>
        <ul class="toDoList">
